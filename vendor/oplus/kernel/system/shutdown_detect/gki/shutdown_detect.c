...
#endif
typedef int (*sensor_remove_notify_handler) (void);
static sensor_remove_notify_handler s_notify_handler = NULL;
void register_notify_handler(int (*remove_notify_handler) (void))
{
    s_notify_handler = remove_notify_handler;
}
EXPORT_SYMBOL_GPL(register_notify_handler);
